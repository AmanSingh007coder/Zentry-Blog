...
const BlogCard = ({ post, showActions = false, onDelete }) => {
  ...
  return (
    <div className="group bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
      ...
      <Link to={`/read-blog/${post._id}`} className="flex flex-col flex-grow">
        ...
        <div className="p-6 flex flex-col flex-grow">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            {/* This container holds both the bookmark and 3-dots menu */}
            <div className="flex items-center space-x-2">
              ...
              {/* The 3-dots menu will only appear if showActions is true */}
              {showActions && (
