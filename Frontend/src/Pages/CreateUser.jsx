  ...
  return (
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button type="submit" className="w-full py-2 px-4 bg-gradient-to-r from-purple-500 to-purple-700 shadow-md text-white font-semibold rounded-md hover:bg-purple-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors cursor-pointer">Create Account</button>
      </form>
      ...
      <button type="button" onClick={handleGoogleSignUp} className="w-full flex items-center justify-center py-2 px-4 border border-orange-500 rounded-md shadow-sm bg-white text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer">
